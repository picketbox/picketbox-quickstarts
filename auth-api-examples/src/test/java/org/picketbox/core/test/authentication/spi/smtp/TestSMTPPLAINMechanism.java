...
package org.picketbox.core.test.authentication.spi.smtp;
 ...
 *
 */
public class TestSMTPPLAINMechanism extends AbstractAuthenticationMechanism {

    /* (non-Javadoc)
     * @see org.picketbox.core.authentication.api.AuthenticationMechanism#getClient()
     */
    public AuthenticationClient getClient() {
        return new TestSMTPPLAINClient();
    }

    /* (non-Javadoc)
     * @see org.picketbox.core.authentication.api.AuthenticationMechanism#getClient(java.lang.String)
     */
    public AuthenticationClient getClient(String host) {
        return new TestSMTPPLAINClient(host);
    }
