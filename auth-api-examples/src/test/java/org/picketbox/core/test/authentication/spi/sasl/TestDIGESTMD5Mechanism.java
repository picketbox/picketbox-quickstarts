 ...
 *
 */
public class TestDIGESTMD5Mechanism extends AbstractAuthenticationMechanism {

    /* (non-Javadoc)
     * @see org.picketbox.core.authentication.api.AuthenticationMechanism#getClient(boolean)
     */
    public AuthenticationClient getClient() {
        return new TestDIGESTMD5Client();
    }
    ...
    public AuthenticationService getService() {
        return new TestDIGESTMD5Service(this);
    }
