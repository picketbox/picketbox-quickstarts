PicketBox HTTP Configuration API Example
===================

What is it?
-----------

This example demonstrates how provide a custom configuration using the Configuration API for PicketBox HTTP applications.
